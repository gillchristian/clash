                    ...
                    case 'light':
                        for (var i = vm.light_troops.length - 1; i >= 0; i--) {
                            for (var g = vm.light_barracks.length - 1; g >= 0; g--) {
                                ...
                                // vm.light_barracks[g].amount[g] = 0; // this is the same
                            };
                    ...
                    case 'dark':
                        for (var i = vm.dark_troops.length - 1; i >= 0; i--) {
                            for (var g = vm.dark_barracks.length - 1; g >= 0; g--) {
                                ...
                                // vm.dark_barracks[g].amount[g] = 0; // this is the same
                            };
                ...
                switch (type) {
                    case 'light':
                        for (var i = 0; i < vm.light_barracks.length; i++) {
                            ...
                            // check if barracks are not full / if unit fit in the barrack
                            ...
                            if (condition.troopAvailable && condition.barrackSpace) {
                                available_barracks.push(i);
                            }
                        };

                        for (var i = 0; i < available_barracks.length; i++) {

                            if ((vm.barrack_time('light', i) + vm.light_troops[index].time) < diference) {
                                lower_barrack = available_barracks[i];
